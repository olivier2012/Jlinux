...
public class Jlinux_Accessory extends Jlinux_Host {
   ...
   @Column(name = "video_card", length = 12)
    ...
    public Jlinux_Accessory(long HostId, String H_Host_name, long UserId, String H_User_name, String H_Passwd, Date Access_time, Date Created_time, String Host_UUID) {
