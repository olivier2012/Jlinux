...
@Service("Jlinux_H_WithTimeService")
@Transactional
@Component
public class Jlinux_Host_DAO_Impl implements Jlinux_Host_DAO {
    ...
    @Autowired
    private Jlinux_Host_DAO hostdao;
   ...
   @Override
    ...
    @Override
    public void insert(Jlinux_H_WithTime o) {
        hostdao.insert(o);
    }

    @Override
    public void update(Jlinux_H_WithTime o) {
        hostdao.update(o);
    }

    @Override
    public void delete(Jlinux_H_WithTime o) throws Exception {
        hostdao.delete(o);   
    }

    @Override
    public Jlinux_H_WithTime getById(Serializable id) {
         return hostdao.getById(id);
    }

    @Override
    public List<Jlinux_H_WithTime> getAll() {
