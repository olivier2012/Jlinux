...
public class Jlinux_User_DAO_Impl implements     Jlinux_User_DAO {
   ...
   @Override
    ...
    @Override
    public Jlinux_User getJlinux_UserByID(Serializable id) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void insert(Jlinux_User o) {
       userdao.insert(o);
    }

    @Override
    public void update(Jlinux_User o) {
        userdao.update(o);
    }

    @Override
    public void delete(Jlinux_User o) throws Exception {
         userdao.deletebyJlinux_Users(o.getUserId());
    }

    @Override
    public Jlinux_User getById(Serializable UserId) {
       return userdao.getJlinux_UserByID(UserId); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<Jlinux_User> getAll() {
       return userdao.getListOfJlinux_Users();
    }
